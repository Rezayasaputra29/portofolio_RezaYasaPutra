        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            ...
            <div className="flex gap-4 mb-12">
              ...
              >
                <FaGithub size={20} /> {language === "en" ? "Code" : "Kode"}
              </a>
            </div>
            ...
            {project.visualizations && project.visualizations.length > 0 && (
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 shadow-lg">
                <h3 className="text-xl font-bold text-white mb-8 flex items-center gap-3">
                  ...
                  {language === "en" ? "Data Analysis & Visualizations" : "Analisis Data & Visualisasi"}
                </h3>
                ...
                <div className="flex flex-col gap-10">
                  {project.visualizations.map((vis, idx) => (
                    <div
                      key={idx}
                      className="w-full bg-[#0a0f1c] border border-white/10 rounded-xl p-6 flex flex-col items-center group shadow-md"
                    >
                      <span className="text-cyan-400 text-sm font-bold mb-6 uppercase tracking-widest border-b border-white/10 pb-2 text-center w-full">
                        {vis.label[language]}
                      </span>

                      <div className="w-full flex justify-center items-center overflow-hidden rounded-lg bg-[#020617] p-2 md:p-6">
                        <img
                          src={vis.url}
                          alt={vis.label[language]}
                          className="max-w-full h-auto max-h-[600px] object-contain transform group-hover:scale-[1.03] transition-transform duration-700 ease-out"
                        />
                      </div>
                    </div>
                  ))}
